...
function cat_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'cat' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'cat_custom_background_args', array(
...
function cat_scripts() {
	wp_enqueue_style( 'cat-style', get_stylesheet_uri() );

	wp_enqueue_script( 'cat-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'cat-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
