<div class="blog-box clearfix">
    ...
    <div class="meta">
        ...
        <span><a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta('ID') )); ?>" title="<?php the_author_meta( 'display_name' ); ?>"><?php esc_html_e('by : ' , 'apartvilla'); ?><?php the_author(); ?></a></span>
        <span><?php esc_html_e('in : ' , 'apartvilla'); ?><?php the_category(', '); ?></span>
