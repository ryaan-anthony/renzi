	...
	<div class="container">
			...
			<div class="<?php echo esc_attr($classes);?>">
              ...
              <?php the_category();?>
						...
						<div class="row">
							<div class="col-md-6">
           			<a href="http://robotpower.me/wordpress/contact/"  class="btn btn-primary btn-lg btn-block" role="button">Schedule Visit</a>
						 		</br>
					 		</div>
						 	<div class="col-md-6">
							 <a href="http://robotpower.me/wordpress/rental-application/"  class="btn btn-primary btn-lg btn-block" role="button">Apply Now</a>
						 	</div>
			 			</div>
