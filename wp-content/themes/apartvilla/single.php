	...
	<div class="container">
			...
			<div class="<?php echo esc_attr($classes);?>">
              ...
              <?php the_category();?>
						...
						<div class="row">
							<div class="col-md-6">
           			<a href="http://robotpower.me/wordpress/contact/"  class="btn btn-warning btn-lg btn-block" role="button"><span class="glyphicon glyphicon-phone-alt" aria-hidden="true"></span>   Schedule Visit</a>
						 		</br>
					 		</div>
							<div class="col-md-6">
							 <a href="http://robotpower.me/wordpress/rental-application/"  class="btn btn-warning btn-lg btn-block" role="button"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>   Apply Now</a>
						 	</div>
			 			</div>
