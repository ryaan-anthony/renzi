...
ob_start();?>
	...
	?>
		...
		if( $post_terms ) foreach( $post_terms as $p_term ) $term_slug .= $p_term->slug.' ';?>		
		   ...
		   <!-- .single-gallery -->
			<div class="single-gallery anim-5-all masonryImage mix span-6 <?php echo esc_attr($term_slug);?>">
				<div class="img-holder">
					<?php the_post_thumbnail('apartvilla_nine', array('class' => 'img-responsive'));?>
					<div class="content">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="img-holder item-image">
							<img src="<?php echo esc_url(get_template_directory_uri());?>/img/gallery2/1.jpg" alt="<?php esc_html_e('image', 'apartvilla');?>">
						</div>
					</div>
